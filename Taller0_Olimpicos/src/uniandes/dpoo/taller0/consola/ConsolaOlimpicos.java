...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisDeAtleta()
	{
		...
		String paisAtleta = calculadora.paisDeAtleta(nombreAtleta);
		if(paisAtleta != null) 
		{
			System.out.println(nombreAtleta + " representa a " + paisAtleta);
		}
		else 
		{
			System.out.println("No se encontro al atleta buscado");
		}
	}
